...
public class SearchCategoryH extends AppCompatActivity {
    ListView listView;
    String[] title;
    String[] description;
    int[] icon;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 0; i < title.length; i++) {
            ...
            if(title[i].contains("healthy") || title[i].contains("Healthy") || description[i].contains("healthy") || description[i].contains("Healthy")) {
